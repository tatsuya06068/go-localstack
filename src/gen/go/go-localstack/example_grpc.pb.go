...
const (
	...
	ExampleService_InsertExample_FullMethodName = "/example.ExampleService/InsertExample"
)
...
type ExampleServiceClient interface {
	...
	InsertExample(ctx context.Context, in *InsertExampleRequest, opts ...grpc.CallOption) (*InsertExampleResponse, error)
}
...
func (c *exampleServiceClient) InsertExample(ctx context.Context, in *InsertExampleRequest, opts ...grpc.CallOption) (*InsertExampleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InsertExampleResponse)
	err := c.cc.Invoke(ctx, ExampleService_InsertExample_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExampleServiceServer interface {
	...
	// Insert用のgRPCメソッドを定義します
	InsertExample(context.Context, *InsertExampleRequest) (*InsertExampleResponse, error)
...
func (UnimplementedExampleServiceServer) InsertExample(context.Context, *InsertExampleRequest) (*InsertExampleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InsertExample not implemented")
}
...
func _ExampleService_InsertExample_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InsertExampleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExampleServiceServer).InsertExample(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExampleService_InsertExample_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServiceServer).InsertExample(ctx, req.(*InsertExampleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ExampleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "InsertExample",
			Handler:    _ExampleService_InsertExample_Handler,
		},
	},
